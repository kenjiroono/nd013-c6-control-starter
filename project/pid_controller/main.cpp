...
int main ()
{
  ...
  **/
  PID pid_steer = PID();
  pid_steer.Init(0.1, 0.0005,0.003, 1.2, -1.2);
  ...
  **/
  ...
  pid_throttle.Init(0.21,0.001,0.005, 1, -1);
...
//           // Update the delta time with the previous command
          ...
          **/
          ...
          // desired speed is defined at the end of the generated trajectory so subtract current trajectory to 
          // get the throttle error
